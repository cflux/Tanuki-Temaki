    ...
    extend: {
      colors: {
        ...
        cyber: {
          ...
          'secondary-dim': 'var(--cyber-secondary-dim)',
          'secondary-bright': 'var(--cyber-secondary-bright)',
          text: 'var(--cyber-text)',
      ...
      boxShadow: {
        ...
        'cyber-secondary-sm': '0 0 4px var(--cyber-secondary)',
        'cyber-secondary-md': '0 0 8px var(--cyber-secondary)',
        'cyber-secondary-lg': '0 0 12px var(--cyber-secondary)',
      },
      animation: {
